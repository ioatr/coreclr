...
typedef void (*QBATTLE_INIT_FUNC)();
typedef void (*QBATTLE_START_FUNC)();
typedef const char* (*QBATTLE_UPDATE_FUNC)(const float* param);
typedef void (*QBATTLE_FREE_HGLOBAL_FUNC)(const char* param);
